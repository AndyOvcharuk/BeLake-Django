...
# the signal is triggered after a delete() function in the Post model
@receiver(post_delete, sender=Post)
# taking the model and the specific post (instance) as parameters
...
# the signal is triggered before a save() function in the Post model
